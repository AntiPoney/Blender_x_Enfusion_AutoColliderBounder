bl_info = {
    ...
    "doc_url": "https://github.com/AntiPoney/Blender_x_Enfusion_PerCollectionExport",
    "tracker_url": "https://github.com/AntiPoney/Blender_x_Enfusion_PerCollectionExport/issues",
}
